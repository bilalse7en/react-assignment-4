  ...
  function SignUp() {
    ...
    const validateUsername = () => {
      if (userName.length < 3) {
        showError(setUserNameError, "Username must be at least 3 characters long.");
        return false;
      } else {
        ...
        <div className="flex h-screen">
          ...
          <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
            <div className="max-w-md w-full p-6">
              <h1 className="text-3xl mb-6 text-black text-center">Sign Up</h1>
              <h1 className="text-sm mb-6 text-gray-500 text-center">
              ...
              <div className="mb-2">
                <label
                  htmlFor="username"
                  className="block text-sm font-medium text-gray-700 font"
                >
                  Username
                </label>
                <input
              ...
              <div className="mb-2">
                ...
                onClick={handleSignUp}
                  id="signupBtn"
                  className="mt-3 w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300"
                >
                  Sign Up
                </button>
              </div>
              <div className="text-sm text-gray-600 text-center">
                <p>
                  ...
                  <a href="./signin.html" className="text-black hover:underline">
                    Login here
                  </a>
                </p>
              </div>
